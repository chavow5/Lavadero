      ...
      <div className="relative z-10 w-full max-w-5xl h-[85vh] sm:h-[90vh] bg-black/50 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/10 flex flex-col">
        <div className="mb-4 text-center">
          ...
          <p className="mt-2 text-sm text-gray-300">
            Seleccioná un turno de 90 minutos. Después confirmamos por WhatsApp
            los detalles y la dirección.
          </p>
          <p className="text-xs text-yellow-200 mb-2">
            Haz clic en <span className="font-semibold">Entendido</span> para
            confirmar las cookies. (En celular, el aviso puede tapar el
            calendario)
          </p>
        </div>
        ...
        <p className="mt-4 text-xs text-gray-400 text-center">
          Si tenés problemas para reservar, escribinos por WhatsApp y te
          ayudamos. -{" "}
          <a
          ...
          <br />y si ya reservaste, escribinos para terminar de confirmar la
          reserva.
        </p>
      </div>
    </section>
